...
export function ChiTietPhieuNhapColumns({
	onEdit,
	onDelete,
	thietBiList,
	loaiThietBiList,
...
}: Props): ProColumns<ChiTietPhieuNhapItemType>[] {
	return [
		{
			title: "STT",
			dataIndex: "stt",
...

		{
			...
			valueEnum: phieuNhapList.reduce(
				(acc, item) => {
					acc[item.id] = {
						text: item.ma_phieu_nhap,
					};
